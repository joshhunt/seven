...
class EpisodeHeresy extends SeasonDefinition {
  ...
  public get label(): string {
    return Localizer.Format(Localizer.Seasons.SeasonNumberSeasonName, {
      seasonNumber: this.seasonNumber,
      seasonName: Localizer.Seasons.EpisodeHeresy,
    });
  }
  ...
  public smallIcon = "/7/ca/destiny/bgs/season26/seasonicon_26.svg";
  public seasonNumber = 26;
}

class SeasonReclamation extends SeasonDefinition {
  public static instance = new SeasonReclamation();
  public get title(): string {
  ...
  public get label(): string {
    return Localizer.Format(Localizer.Seasons.SeasonNumberSeasonName, {
      seasonNumber: this.seasonNumber,
      seasonName: Localizer.Seasons.seasonReclamation,
    });
  }
  public image = "";
  public progressPageImage =
    "/7/ca/destiny/bgs/season27/seasonbackground_27.jpg";
  public smallIcon = "/7/ca/destiny/bgs/season27/seasonicon_27.svg";
  public seasonNumber = 27;
}

export class SeasonsDefinitions {
  public static previousSeason = EpisodeHeresy.instance;
  public static currentSeason = SeasonReclamation.instance;

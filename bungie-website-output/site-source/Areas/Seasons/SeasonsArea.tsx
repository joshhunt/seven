  ...
  public render() {
    ...
    return (
      <SwitchWithErrors>
        ...
        />
        <Route
          path={RouteDefs.Areas.Seasons.getAction("SeasonOfTheWish").path}
          component={createAsyncComponent(
            () =>
              import(
                "./ProductPages/Season23/SeasonOfTheWish" /* webpackChunkName: "Season23" */
              )
          )}
        />
        <Route
          path={RouteDefs.Areas.Seasons.getAction("EpisodeEchoes").path}
          component={createAsyncComponent(
            () =>
              import(
                "./ProductPages/Season23/SeasonOfTheWish" /* webpackChunkName: "Season24" */
              )
          )}
        />
        <Route

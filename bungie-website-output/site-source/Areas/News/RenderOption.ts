...
export const defaultNodeOption: RenderOption = {
  ...
  ["social-embeds"]: (node: Node, next: Next) => {
    return `<div style="display: flex; max-width: 550px; width: 100%; margin-top: 10px; margin-bottom: 10px;">
			<iframe 
				scrolling="no" 
				frameborder="0" 
				allowtransparency="true" 
				allowfullscreen="true" 
				style="position: static; visibility: visible; width: 550px; height: 885px; display: block; flex-grow: 1;" 
				src=${node.attrs.src}>
			</iframe>
			</div>`;
  },

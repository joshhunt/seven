...
export function createReducer<S extends NotFunction<any>>(
  ...
  ] = executeReducerBuilderCallback(mapOrBuilderCallback); // Ensure the initial state gets frozen either way (if draftable)

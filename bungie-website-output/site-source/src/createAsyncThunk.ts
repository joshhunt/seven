...
> = IsAny<
  ...
  unknown extends ThunkArg
    ...
    ? WithStrictNullChecks<
        ...
        (
          arg?: ThunkArg
        ) => AsyncThunkAction<Returned, ThunkArg, ThunkApiConfig>, // without strict null checks this will match everything, so don't make it optional

...
export class ResponsiveDataStore extends DataStore<
  IResponsiveState,
  ResponsiveMonitor
> {
  ...
  public static readonly InitialState: IResponsiveState = {
    gridmax: false,
    large: false,
    max: false,
    medium: false,
  ...
  constructor() {
    super(ResponsiveDataStore.InitialState, {
      observerClassConstructor: ResponsiveMonitor,
    });

    this.mediaQueries = [
      ResponsiveDataStore.max,
      ResponsiveDataStore.gridmax,
      ResponsiveDataStore.large,
      ResponsiveDataStore.medium,
      ResponsiveDataStore.mobile,
      ResponsiveDataStore.tiny,
      ResponsiveDataStore.pico,
    ];
  }
  ...
  public actions = this.createActions({
    ...
    refreshState: () => {
      const newSubscriptionState: IResponsiveState = {
        ...ResponsiveDataStore.InitialState,
      };

...
interface IGlobalAlertsProps extends GlobalStateComponentProps<"responsive"> {}

interface IGlobalAlertsState {
 ...
 * @returns
 */
class GlobalAlertsInner extends React.Component<
  IGlobalAlertsProps,
  IGlobalAlertsState
> {
  constructor(props: IGlobalAlertsProps) {
    super(props);
...
export const GlobalAlerts = withGlobalState(GlobalAlertsInner, ["responsive"]);
